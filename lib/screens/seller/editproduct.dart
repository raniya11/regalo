...
class EditProduct extends StatefulWidget {
  ...
  EditProduct({Key? key,this.id,this.item}) : super(key: key);
...
class _EditProductState extends State<EditProduct> {
  ...
  var productId;
QueryDocumentSnapshot? _item;
  @override
  void initState() {
    _item=widget.item;
    productNamecontroller.text=_item!['productName'];
    productIDcontroller.text=_item!['productCode'];
    _category=_item!['category'];
    pricecontroller.text=_item!['price'];
    offerscontroller.text=_item!['offer'];
    descriptioncontroller.text=_item!['description'];
    imageurl=_item!['productImage'];
    productId = uuid.v1();
    super.initState();
  }
